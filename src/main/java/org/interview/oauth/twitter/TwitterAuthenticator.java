...
public class TwitterAuthenticator {
    ...
    /**
     * Generates authentication headers for specific requestMethod and url
     * @param requestMethod
     * @param url
     * @return String representation of authentication headers
     * @throws TwitterAuthenticationException
     */
    public String getAuthorizationHeaderForRequest(RequestMethod requestMethod, GenericUrl url) throws TwitterAuthenticationException{
        ...
        try {
            parameters.computeSignature(requestMethod.name(), url);
